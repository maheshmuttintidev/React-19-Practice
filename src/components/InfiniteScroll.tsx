...
export const InfiniteScroll = () => {
  ...
  const itemsGrid = Array(4)
    ...
    .map((_, idx) => {
      return (
        <div
          className="text-teal-800 bg-teal-300 border-2 border-teal-500 rounded-md w-10 h-10 text-center flex justify-center items-center"
          key={`item-${idx}`}
          style={{
  ...
  return (
    <div className="flex flex-col justify-center items-center">
      ...
      <div className="h-[400px] w-[300px] shadow-lg overflow-y-scroll border-1 border-slate-300 py-3">
